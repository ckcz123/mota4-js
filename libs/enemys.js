...
enemys.prototype.init = function() {
    this.enemys = {
        'greenSlime': {'name': '绿色史莱姆', 'hp': 130, 'atk': 14, 'def': 4, 'money': 1, 'special': 0},
        'redSlime': {'name': '红色史莱姆', 'hp': 156, 'atk': 21, 'def': 5, 'money': 1, 'special': 0},
        'blackSlime': {'name': '青头怪', 'hp': 189, 'atk': 27, 'def': 6, 'money': 3, 'special': 0},
        'slimelord': {'name': '史莱姆王', 'hp': 472, 'atk': 300, 'def': 150, 'money': 35, 'special': 0},
        ...
        'goldHornSlime': {'name': '金角史莱姆', 'hp': 0, 'atk': 0, 'def': 0, 'money': 0, 'special': 0},
        ...
        'silverSlime': {'name': '银色史莱姆', 'hp': 0, 'atk': 0, 'def': 0, 'money': 0, 'special': 0},
        'swordEmperor': {'name': '剑圣', 'hp': 0, 'atk': 0, 'def': 0, 'money': 0, 'special': 0},
        'whiteHornSlime': {'name': '尖角史莱姆', 'hp': 0, 'atk': 0, 'def': 0, 'money': 0, 'special': 0},
